...
with st.container(border=True):
    ...
    with st.form("query"):
        st.markdown("<b style = 'font-size:0.95rem; color: black;'>Query file(s)*</b>", unsafe_allow_html=True)
        ...
        with col1:
            st.markdown("<b style = 'font-size:0.95rem; margin-top: 10px; color: black;'>Extra Features</b>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("<b style = 'font-size:0.95rem;margin-top: 10px; color: black;'>Email Address*</b>", unsafe_allow_html=True)
