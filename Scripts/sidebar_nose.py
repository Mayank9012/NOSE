    ...
    with st.sidebar:
        ...
        def generate_step_circle(step_name, step_index, completed_step, step_active):
            ...
            if completed_step == '1':
                ...
                <div class="stStepCircle2" style="color:{checked_color};"><p style="position:relative; transform: translateX(-0.05px) translateY(-8.751px);"><img src="https://svgshare.com/i/17pL.svg" width="35" height="35"></p></div>
                """
                return circle_html
            else:
                circle_html = f"""
