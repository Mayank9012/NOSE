...
def sidebar(step1, step2, step3, step4, step5, step6):
    ...
    <style>
        ...
        .stProgress>div>div {
            ...
            transform: translateX(-119px) translateY(-18px);
        }
    ...
    with st.sidebar:
        ...
        def generate_step_circle(step_name, step_index, completed_step, step_active):
            ...
            if completed_step == '1':
                ...
                <div class="stStepCircle2" style="color:{checked_color};"><p style="position:relative; transform: translateX(-0.05px) translateY(-9.751px);"><img src="https://svgshare.com/i/17pL.svg" width="35" height="35"></p></div>
                """
                return circle_html
            else:
                circle_html = f"""
