...
def sidebar(step1, step2, step3, step4, step5, step6):
    ...
    <style>
        ...
        .stStepCircle2 {
            ...
            display: flex;
            margin-bottom: 1vh;
            transform: translateX(44px) translateY(-265.9px);
            justify-content: center;
            align-items: left;
            color: white;
            text-wrap: wrap;
        ...
        .steps{
            transform: translateY(-980%) translateX(29%);
        }
        ...
        def generate_step_circle(step_name, step_index, completed_step, step_active):
            ...
            if completed_step == '1':
                ...
                <div class="stStepCircle1" style="display: inline;">
                    <p class = "steps" style="font-weight:bold; font-size:0.9rem;">
                    <a href="{steps_link[i]}" style="color:{checked_color}; text-decoration:none;" target="_self">{step_name_display}</a>
                    </p>
                </div>
                <div class="stStepCircle2" style="color:{checked_color};"><p class="image" style="position:relative; transform: translateX(-0.05px) translateY(-8.751px);"><img src="https://svgshare.com/i/17pL.svg" width="35" height="35"></p></div>
                """
                return circle_html
            else:
                circle_html = f"""
